import{h as c}from"./moment-C5S46NFB.js";import{P as u}from"./index-C5E5KQtJ.js";const f=`
      ...
      <table class="grid" style="margin-top:8px;">
        <tr>
          <td class="box" style="width:50%;">
            ...
            <div class="md" style="font-weight:700;">${e(o(a.total))} Bs</div>
          </td>
          <td class="box" style="width:50%;">
            <div class="label">Emitido</div>
            <div class="md">${e(a.emitido)}</div>
          </td>
        </tr>
      </table>
    </div>
  `)}async function A(t,d,i=null){const[s,l]=await Promise.all([i?.cliente?Promise.resolve(i):p(t,d),g(t)]),a=m(s,l);return v($(a))}async function N(t,d,i=null){const[s,l]=await Promise.all([i?.cliente?Promise.resolve(i):p(t,d),g(t)]),a=m(s,l);return v(w(a))}export{N as a,A as b,D as c,O as p};
