...
<!--          </td>-->
  ...
  `)}async function N(t,d,i=null){const[s,l]=await Promise.all([i?.cliente?Promise.resolve(i):b(t,d),y(t,d)]),a=P(s,l),n=a.pagos.map(r=>`
    <tr>
  ...
  `)}async function O(t,d,i=null){const s=i?.cliente?i:await b(t,d),l=Number(s?.cambio_dolar)||await g(t),a=m(s,l);return v(w(a))}async function A(t,d,i=null){const s=i?.cliente?i:await b(t,d),l=Number(s?.cambio_dolar)||await g(t),a=m(s,l);return v($(a))}export{A as a,O as b,D as c,N as p};
