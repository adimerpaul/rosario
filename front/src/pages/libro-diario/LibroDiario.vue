<template>
  <q-page class="q-pa-sm bg-grey-2">
    <q-card flat bordered>
      <q-card-section class="row items-center q-col-gutter-sm">
        ...
        <div class="col-12 col-md-3">
          <q-input
            ...
            dense outlined label="Caja inicial (Bs.)"
          />
        </div>

        <div class="col-12 col-md-3 flex items-center">
          <q-btn color="primary" icon="save" label="Guardar caja" no-caps :loading="loadingSave" @click="guardarCaja" />
          <q-btn color="grey" flat icon="refresh" label="Actualizar" class="q-ml-sm" no-caps :loading="loading" @click="fetchDiario" />
        </div>
      ...
      <!-- INGRESOS -->
      <q-card-section>
        <div class="text-subtitle1 text-weight-bold q-mb-sm">Ingresos</div>
        ...
        <q-card bordered class="q-mb-md">
          ...
          <q-markup-table flat bordered dense>
            ...
            <tbody>
            <tr v-for="it in ingresos.ordenes.items" :key="it.id">
...
export default {
  ...
  data () {
    return {
      ...
      openingAmount: 0,
      ingresos: { ordenes: { total: 0, items: [] } },
      totalIngresos: 0,
      loading: false,
      loadingSave: false
    }
