...
const linksList = [
  ...
  {title: 'Ingresar Joyas', icon: 'diamond', link: '/joyas', can: ['Administrador', 'Vendedor']},
  {title: 'Estuches', icon: 'inventory_2', link: '/estuches', can: ['Administrador', 'Vendedor']},
  {title: 'Crear Venta', icon: 'point_of_sale', link: '/ventas-joyas/crear', can: ['Administrador', 'Vendedor']},
  {title: 'Lista de Ventas', icon: 'sell', link: '/ventas-joyas', can: ['Administrador', 'Vendedor']},
//   clientes ordenes prestamos libroDIario ordenesRetrasadso y prestamosRetrasados
  ...
  {title: 'Crear Ordenes', icon: 'add_circle', link: '/ordenes/crear', can: ['Administrador', 'Vendedor']},
  {title: 'Lista de Ordenes', icon: 'receipt_long', link: '/ordenes', can: ['Administrador', 'Vendedor']},
  {title: 'Crear Prestamo', icon: 'add_circle', link: '/prestamos/crear', can: ['Administrador', 'Vendedor']},
  {title: 'Lista de Prestamos', icon: 'paid', link: '/prestamos', can: ['Administrador', 'Vendedor']},
